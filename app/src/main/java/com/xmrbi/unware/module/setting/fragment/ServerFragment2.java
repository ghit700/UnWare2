...
public class ServerFragment2 extends BaseFragment {
    ...
    public static ServerFragment2 newInstance() {
        ServerFragment2 fragment = new ServerFragment2();
        return fragment;
    }

    @Override
    protected int getLayout() {
        return R.layout.setting_fragment_server2;
    }
...
//                });
    ...
    public void saveStoreHouseSetting() {
        ...
        mMainRepository.saveStoreHouseConfig(params)
