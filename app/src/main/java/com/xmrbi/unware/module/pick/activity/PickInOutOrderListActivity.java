 ...
 */
public class PickInOutOrderListActivity extends BaseActivity {
    public static void lauch(Context context, User user) {
        Bundle bundle = new Bundle();
        bundle.putSerializable("user", user);
        ActivityStackUtils.lauch(context, PickInOutOrderListActivity.class, bundle);
    }
    ...
    protected void onViewCreated() {
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                InOutOrder inOutOrder=mLstInOutOrders.get(position);
                PickInOutOrderDeviceActivity.lauch(mContext,inOutOrder.getCode(),mUser,inOutOrder.getId(),inOutOrder.getInOutDate());
            }
        });
    }
    ...
    private void queryInOutOrderList() {
        mDeliverRepository.queryInOutOrderList(mUser.getId(),mStoreHouse.getId(),false)
